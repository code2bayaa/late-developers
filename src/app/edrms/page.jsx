    ...
    return (
        <>
                ...
                <div className={ windowWidth > 800 ? "flex relative left-[10%] w-[80%]" : "flex flex-col w-[100%]"}>
                    ...
                    <ol style={{ listStyleType: 'decimal', paddingLeft: '20px' }}>
                        <li>
                            ...
                            <p>Digitizing document management eliminates time spent searching for files or managing physical storage, improving overall productivity.</p>

                        </li>
                        <li>
                            <b>Data Security and Backup</b>
                            <p>EDRMS protects sensitive information with encryption, access controls, and automatic backups, ensuring data integrity and confidentiality.</p>

                        </li>
                        <li>
                            <b>Regulatory Compliance</b>
                            <p>Many industries require businesses to maintain detailed records for compliance. EDRMS ensures records are securely stored and easily retrievable for audits or legal needs.</p>

                        </li>
                        <li>
                            <b>Cost Savings</b>
                            <p>Reducing the reliance on paper, storage space, and manual labor translates to significant cost savings over time.</p>

                        </li>
                        <li>
                            <b>Sustainability</b>
                            <p>A digital document management system reduces paper usage, supporting environmentally friendly business practices.</p>
            ...
            <div className={ windowWidth > 800 ? "relative flex h-[auto] w-[100%] bg-[#E1F977]" : "relative flex flex-col h-auto w-[100%] bg-[#E1F977]"}>
                <Image src = {edrms2} alt="late-developers" style={{height:windowWidth ? "100%" : "50%"}} className={windowWidth > 800 ? "w-[50%] p-0 m-[1%] z-[2] h-[100px] object-contain" : "w-[100%] object-contain"}/>
