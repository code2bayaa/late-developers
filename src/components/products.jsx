...
const PRODUCTS = ({products, setProducts}) => {
    ...
    return (
        <div className={windowWidth > 800 ? "w-[80%] mx-[10%]" : "w-[90%] mx-[5%]"}>
            ...
            <div className="w-[100%] h-[70px] bg-[#000] flex flex-row text-white">
                <form 
                    className="w-[90%] h-[100%] flex flex-row"
                    onSubmit={searchBar}
                    >
                    <input
            ...
            <div className="w-[100%] h-auto flex flex-row flex-wrap">
                ...
                {
                    products.hasOwnProperty("products") ?
                    ...
                    :
                        <Image src = {shopping} alt="late developers store" style={{height:"50%"}} width={200} height={200} className="w-[100%] object-contain"/>
