...
const marketing = [
    {
        ...
        icon:<FontAwesomeIcon style={{fontSize:"400%",color:"#000",textAlign:"center"}} icon={faLaptop}/>
    },
    {
        ...
        icon:<FontAwesomeIcon style={{fontSize:"400%",color:"#000",textAlign:"center"}} icon={faThumbsUp}/>
    },
    {
        ...
        icon:<FontAwesomeIcon style={{fontSize:"400%",color:"#000",textAlign:"center"}} icon={faMapPin}/>
    },
    {
        ...
        icon:<FontAwesomeIcon style={{fontSize:"400%",color:"#000",textAlign:"center"}} icon={faCartShopping}/>
    },
    {
        ...
        icon:<FontAwesomeIcon style={{fontSize:"400%",color:"#000",textAlign:"center"}} icon={faMobileAndroid}/>
    },
    {
        ...
        icon:<FontAwesomeIcon style={{fontSize:"400%",color:"#000",textAlign:"center"}} icon={faPenToSquare}/>
    }
]
