                ...
                <div className={windowWidth > 800 ? "w-[70%] flex flex-wrap" : "w-[100%] flex flex-col"}>
                    ...
                    <div className={windowWidth > 800 ? "flex flex-col w-[12%] m-[1%]" : "flex flex-col w-[100%]"}>
                        ...
                        <div id = "introductions-header" className={windowWidth > 800 ? "w-[9%] top-[5%] absolute hidden":"w-[100%] hidden"} style={{fontSize:"90%"}}>
                            ...
                            <Link href="/email"  style={{width:"100%",display:"block"}} className="min-h-[40px] bg-white w-[98%] text-black text-center border-b-[#ccc] border-[1px]" onClick={removeNavBar}>email archiving</Link>
                            <Link href="/edrms"  style={{width:"100%",display:"block"}} className="min-h-[40px] bg-white w-[98%] text-black text-center border-b-[#ccc] border-[1px]" onClick={removeNavBar}>electronic document and records management system</Link>
                            <Link href="/customs"  style={{width:"100%",display:"block"}} className="min-h-[40px] bg-white w-[98%] text-black text-center border-b-[#ccc] border-[1px]" onClick={removeNavBar}>custom solutions</Link>
                    ...
                    <div className={windowWidth > 800 ? "flex flex-col w-[12%] m-[1%]" : "flex flex-col w-[100%]"}>
                        ...
                        <div id="projects-header" className={windowWidth > 800 ? "w-[9%] top-[5%] absolute hidden":"w-[100%] hidden"}>
                            ...
                            <Link href="/arcade"  style={{width:"100%",display:"block"}} className="min-h-[40px] bg-white w-[98%] text-black text-center border-b-[#ccc] border-[1px]" onClick={removeNavBar}>Arcades</Link>  
                        </div>
                    </div>
                    <div className={windowWidth > 800 ? "flex flex-col w-[12%] m-[1%]" : "flex flex-col w-[100%]"}>
                        <div className={windowWidth > 800 ? "h-[25%]" : "h-[40px]"}>
                    ...
                    <div className={windowWidth > 800 ? "flex flex-col w-[12%] m-[1%]" : "flex flex-col w-[100%]"}>
                        ...
                        <div id = "activities-header" className={windowWidth > 800 ? "w-[9%] top-[5%] absolute hidden":"w-[100%] hidden"}>
                            ...
                            <Link href="/blogs"  style={{width:"100%",display:"block"}} className="min-h-[40px] bg-white w-[98%] text-black text-center border-b-[#ccc] border-[1px]" onClick={removeNavBar}>Blogs</Link> 
                            <Link href="/social"  style={{width:"100%",display:"block"}} className="min-h-[40px] bg-white w-[98%] text-black text-center border-b-[#ccc] border-[1px]" onClick={removeNavBar}>Social Media</Link>
                        </div>
                    </div>
                    <div className={windowWidth > 800 ? "flex flex-col w-[12%] m-[1%]" : "flex flex-col w-[100%]"}>
                        <div className={windowWidth > 800 ? "h-[25%]" : "h-[40px]"}>
